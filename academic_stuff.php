...
{
 include("academic_stuff_view.php");
 }else
 {
     echo '<script>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Academic Stuff</li>
			</ol>
		</div><!--/.row-->

		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Academic Stuff</h1>
			</div>
		</div><!--/.row-->
			...
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<table data-toggle="table" data-url="tables/doctors.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    <thead>
						    <tr>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-heading">Add New Academic Stuff</div>
					<div class="panel-body">
                    <form role="form" action="ins_doctor.php" method="post">
				  <div class="form-group">
				  
				  <label>Academic Doctor Name</label>
