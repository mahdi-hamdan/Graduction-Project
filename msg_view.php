<?php
if (file_exists('tables/msg.json'))
unlink('tables/msg.json');
include('conn.php');
// inbox only
//$sql = "SELECT * FROM `messages` where type = 1";
$id = $_SESSION["userid"] ;
// inbox only
$sql = "SELECT * FROM `messages` where type = 1 and id_to=".$id;
